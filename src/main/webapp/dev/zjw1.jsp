    ...
    <script type="text/javascript">  
        ...
        function connect() {  
            ...
            if ('WebSocket' in window) {  
                ws= new WebSocket("ws://127.0.0.1:8080/dingdong/websck");  
                console.log("ws://127.0.0.1:8080/dingdongs/websck");  
            }else {  
                ws = new SockJS("http://127.0.0.1:8080/dingdong/sockjs/websck");  
                console.log("http://127.0.0.1:8080/dingdong/sockjs/websck");  
            }  
            //websocket = new SockJS("http://localhost:8080/dingdong/sockjs/websck");  
            ws.onopen = function () {  
                alert('open');  
                setConnected(true);  
